(() => {
    ...
    let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
        ...
        if (targetBlockElement) {
            let headerItem = "";
            let headerItemHeight = 56;
            if (window.innerWidth < 768) headerItemHeight = 56; else headerItemHeight = 64;
            if (noHeader) {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".cases-img__slider")) new swiper_core_Swiper(".cases-img__slider", {
            ...
            zoom: true,
            pagination: {
                el: ".cases-img__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
        ...
        if (document.querySelector(".testimonials-reviews__slider")) new swiper_core_Swiper(".testimonials-reviews__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    function initMobileScrollAnimation() {
        ...
        const stepCenters = Array.from(steps).map((step => step.offsetTop + step.offsetHeight / 2));
    ...
    function startDesktopLineAnimation() {
        ...
        function run() {
            ...
            function animate(timestamp) {
                ...
                if (progress >= 1) line.classList.add("full"); else requestAnimationFrame(animate);
            }
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        fileInput.addEventListener("change", (() => {
            if (fileInput.files.length > 0) fileName.textContent = `Selected: ${fileInput.files[0].name}`; else fileName.textContent = "";
        }));
    }));
